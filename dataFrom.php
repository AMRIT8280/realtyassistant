...
<?php 
	include ("config.php");
	echo $CC_AV_MERCHANT_ID;
	echo "<br>";
	echo $CC_AV_ACCESS_CODE;
	echo "<br>";
	echo $CC_AV_WORKING_KEY;
?>
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>TID	:</td><td><input type="text" value="TNX<?= rand(10000,999999) ?>" name="tid" id="tid" /></td>
				</tr>
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="<?= $CC_AV_MERCHANT_ID ?>"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?= $CC_AV_REDIRECT_URL ?> ?>"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?= $CC_AV_CANCEL_URL ?>"/></td>
			 	</tr>
			 	<tr>
