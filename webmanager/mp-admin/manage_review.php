...
function main()
{
  ...
  $sql_list_about = "SELECT * FROM " . DB_C_REVIEW . "  WHERE 1 " . $con . " AND status!='D' ORDER BY id DESC";
  $qry_list_about = mysqli_query($link, $sql_list_about);
  $num_list_about = mysqli_num_rows($qry_list_about);


  $countShow = "SELECT count(*) FROM " . DB_C_REVIEW . "  WHERE 1 " . $con . " AND status!='D' ORDER BY id DESC";
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 breadcrumb-header">
          <div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Manage Review</a></div>
        </div>
      </div>
      <!-- /.row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="panel tabbed-panel panel-success">
            <div class="panel-heading clearfix">
              <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Manage Review
                  </strong></a></div>
                            ...
                            <?php if ($num_list_about > 0) { ?>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><?php echo $cnt++ ?></td>
                                  <td>
                                    <img src="../../uploads/review/<?php echo $row_list_about['image_name'] ?>" width="70px" />
                                  </td>
                                  <td><?php echo $row_list_about['name']; ?></td>
                                  <td><?php echo $row_list_about['review']; ?></td>
                                  <td><?php echo formatDate($row_list_about['main_date']); ?></td>
                      ...
                      <div class="table-responsive">
                        <table width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td width="14%">Name <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                            ...
                            <tr>
                              <td width="14%">Upload Image <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                            ...
                            <tr>
                              <td width="14%">Review</td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    <textarea id="myTextarea" id="review" name="review" class="form-control"></textarea>
                                  </div>
                                  <!-- /input-group -->
                                </div>
                              </td>
                            ...
                            <tr>
                              <td width="14%">Reviewer Type <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-3">
                                  <div class="form-group">
                                    <input type="text" class="form-control" id="type" name="reviewer_type" placeholder="Client or customer" autocomplete="off">
                                  </div>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td width="14%">Rating <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-3">
                                  <div class="form-group">
                                    <input type="number" class="form-control" id="rating" name="rating" placeholder="1-5" autocomplete="off">
                                  </div>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td width="84%">
                                <div class="col-lg-3">
                                  <div class="form-group">
                                    <input type="date" class="form-control" id="main_date" name="main_date" autocomplete="off">
                                  </div>
                                </div>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td colspan="3"><input type="hidden" name="id" value="">
                                ...
                                <a href="manage_review.php" class="btn btn-default">Cancel</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
function insert_about()
{
  ...
  $sql_inset_post = "INSERT INTO " . DB_C_REVIEW . " 

		SET 
		main_date = '" . ConvertRealString($_REQUEST['main_date']) . "',
		image_name='" . $file_name_image . "',
		name = '" . ConvertRealString($_REQUEST['name']) . "',
		review = '" . ConvertRealString($_REQUEST['review']) . "',
    reviewer_type = '" . ConvertRealString($_REQUEST['reviewer_type']) . "',
    rating = '" . ConvertRealString($_REQUEST['rating']) . "'";

  if (mysqli_query($link, $sql_inset_post)) {
    $_SESSION['MSG_ALERT'] = "Latest Information inserted successfully.";
    $_SESSION['IMG_PATH'] = "fa-check";
    $_SESSION['DIV_CLASS'] = "alert-success";

    redirect_mp('manage_review');
    exit();
  } else {
    $_SESSION['MSG_ALERT'] = "Something is wrong.";
    $_SESSION['IMG_PATH'] = "fa-check";
    $_SESSION['DIV_CLASS'] = "alert-success";
...
{
  $result = deleteRecord(DB_C_REVIEW, 'id=' . $_REQUEST['id']);
...
function delete_chk_about()
{
  ...
  foreach ($_REQUEST['public_chkbox'] as $val) {
    if ($val != 'on') {
      ...
      $sql_deletepublication = "UPDATE " . DB_C_REVIEW . " 
											SET 
											status= 'D'
											where id='" . $val . "'";
...
function edit()
{
  ...
  global $link;
  $sql_edit_about = "SELECT * FROM " . DB_C_REVIEW . "  where id ='" . $_REQUEST['id'] . "'";
...
?>
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 breadcrumb-header">
          <div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?= $_SERVER['PHP_SELF'] ?>">Manage Review</a><a href="#" class="current">Edit</a></div>
        </div>
      </div>
      <!-- /.row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="panel tabbed-panel panel-success">
            <div class="panel-heading clearfix">
              <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Manage Review</strong></a></div>
            </div>
                  ...
                  <div class="table-responsive">
                    <table width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td width="15%">Name <font color="#ff0000">*</font>
                          </td>
                          <td width="3%">&nbsp;</td>
                          <td width="87%">
                            <div class="col-lg-6">
                              <div class="form-group"> <span class="input">
                                  <input type="text" class="form-control" id="name" name="name" value="<?php echo $row_edit_about['name']; ?>" autocomplete="off">
                                </span></div>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="87%">
                            <div class="col-lg-6">
                              ...
                              <p id="image_name_alert" style="color:#F00;"></p>
                              <div class="form-group"><img src="../../uploads/review/<?php echo $row_edit_about['image_name'] ?>" width="100px" /></div>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="87%">
                            <div class="col-lg-6">
                              <div class="form-group"> <span class="input">
                                  <textarea id="myTextarea" name="review" id="review" class="form-control">
                                  <?php echo stripslashes(($row_edit_about['review'])); ?>
                                  </textarea>
                                </span></div>
                              <!-- /input-group -->
                            </div>
                        ...
                        <tr>
                          ...
                          <td width="84%">
                            <div class="col-lg-3">
                              <div class="form-group">
                                <input type="text" class="form-control" id="type" name="reviewer_type" value="<?php echo $row_edit_about['reviewer_type']; ?>" placeholder="Client or customer" autocomplete="off">
                              </div>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="84%">
                            <div class="col-lg-3">
                              <div class="form-group">
                                <input type="number" value="<?php echo $row_edit_about['rating']; ?>" class="form-control" id="rating" name="rating" placeholder="1-5" autocomplete="off">
                              </div>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="84%">
                            <div class="col-lg-3">
                              <div class="form-group">
                                <input type="date" class="form-control" id="main_date" name="main_date" autocomplete="off" value="<?php echo $row_edit_about['main_date']; ?>">
                              </div>
                            </div>
                          </td>
                        </tr>
...
function edit_about()
{
  ...
  if ($_FILES['image_name']['name'] != "") {
    ...
    $tmp_name = $_FILES['image_name']['tmp_name'];
    move_uploaded_file($tmp_name, $upload_dir . $file_name_image);
    $sql_inset_post = "UPDATE " . DB_C_REVIEW . " 
                    SET 
					image_name='" . $file_name_image . "'
  ...
  $(document).ready(function() {
    ...
    $('#add_frm').validate({
      ...
      messages: {
        ...
        reviewer_type: 'Please enter type...!',
