...
$sql_list_about = "SELECT * FROM ".DB_NEWS_EVENTS."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_NEWS_EVENTS."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">News & Events</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>News & Events
</strong></a></div>
                      ...
                      <table id="dataTables-example" class="table table-striped table-bordered">
						...
						?>
                          <tr>
                            ...
                            <td><?php  echo $cnt++?></td>
                            <td>
								<img src="../../uploads/news_events/<?php echo $row_list_about['image_name']?>" width="70px" />
                            </td>                            
                    ...
                    <div class="table-responsive">
                      <table width="100%">
                        <tbody>
                          ...
                          <tr>
                            <td width="14%">Date <font color="#ff0000">*</font></td>
                            <td width="2%">&nbsp;</td>
                            <td width="84%"><div class="col-lg-3">
                                <div class="form-group">
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_news_events.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	global $link;	
	$upload_dir='../../uploads/news_events/';
	...
	if($_FILES['image_name']['name']!="")
	 ...
	 $sql_inset_post="INSERT INTO ".DB_NEWS_EVENTS." 
		...
		main_content = '".ConvertRealString($_REQUEST['main_content'])."'";
	...
	$qry_inset_post	=mysqli_query($link,$sql_inset_post);	
		...
		$_SESSION['DIV_CLASS'] ="alert-success"; 
		 ...
		 redirect_mp('manage_news_events');
	exit();
...
{
		$result = deleteRecord(DB_NEWS_EVENTS,'id='.$_REQUEST['id']);
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_NEWS_EVENTS." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_NEWS_EVENTS."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">News & Events</a><a href="#" class="current">Edit</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit News & Events</strong></a></div>
          </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                              <select class="form-control" name="type" id="type">
                                  <option value="">Choose One</option>
                                  <option value="news" <?php if($row_edit_about['type']=='news') echo 'selected';?>>News</option>
                                  <option value="event" <?php if($row_edit_about['type']=='event') echo 'selected';?>>Events</option>
                              </select>
                              </div>
                            <!-- /input-group --> 
                          </div>
                      ...
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            ...
                            <p id="image_name_alert" style="color:#F00;"></p>
                            <div class="form-group"><img src="../../uploads/news_events/<?php echo $row_edit_about['image_name']?>" width="100px" /></div>
                          </div></td>
                      </tr>                     
                      <tr>
	...
	if($_FILES['image_name']['name']!="")

			{
				$file_explode = explode(".",$_FILES['image_name']['name']);
					...
					$tmp_name=$_FILES['image_name']['tmp_name'];
					move_uploaded_file($tmp_name,$upload_dir.$file_name_image);
					$sql_inset_post="UPDATE ".DB_NEWS_EVENTS." 
                    SET 
					image_name='".$file_name_image."'
