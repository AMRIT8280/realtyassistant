...
function main()
{
	...
	$sql_list_about = "SELECT " . DB_CITY . ".*, " . DB_COUNTRY . ".`main_title` AS 'country_name' FROM " . DB_CITY . "," . DB_COUNTRY . "  WHERE 1 " . $con . " AND " . DB_CITY . ".`country_id`=" . DB_COUNTRY . ".`id` AND " . DB_CITY . ".`status`!='D' ORDER BY " . DB_CITY . ".`id` DESC";
	$qry_list_about = mysqli_query($link, $sql_list_about);
	$num_list_about = mysqli_num_rows($qry_list_about);


	$countShow = "SELECT count(*) FROM " . DB_CITY . "  WHERE 1 " . $con . " AND status!='D' ORDER BY id DESC";
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 breadcrumb-header">
					<div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">City</a></div>
				</div>
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel tabbed-panel panel-success">
						<div class="panel-heading clearfix">
							<div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>City Details</strong></a></div>
						...
						<div class="panel-body" id="collapseOne" aria-expanded="true">
                              ...
                              <th>City Name</th>
														...
														<?php if ($num_list_about > 0) { ?>
															...
															?>
																<tr>
																	...
																	<td><?php echo $cnt++ ?></td>
																	<td>
																		<img src="../../uploads/city/<?php echo $row_list_about['image_name'] ?>" width="60px" />
																	</td>
                                  <td><?php echo $row_list_about['main_title']; ?></td>
                                  <td><?php echo $row_list_about['country_name']; ?></td>
								...
								<script language="javascript">
									function Delete(ID, record_no) {
										var UserResp = window.confirm("Are you sure to delete this Country?");
										if (UserResp == true) {
                            ...
                            <tr>
                              <td width="15%">Country Name <font color="#ff0000">*</font>
                              </td>
                              <td width="3%">&nbsp;</td>
                              <td width="82%">
                                <div class="col-lg-6">
                                  ...
                                  <!-- /input-group -->
														...
														<tr>
															<td width="14%">City Name<font color="#ff0000">*</font>
															</td>
															<td width="2%">&nbsp;</td>
															<td width="84%">
																<div class="col-lg-6">
														...
														<tr>
															<td colspan="3"><input type="hidden" name="id" value="">
																...
																<a href="manage_city.php" class="btn btn-default">Cancel</a>
															</td>
														</tr>
													</tbody>
												</table>
...
function insert_about()
{
	...
	$sql_inset_post = "INSERT INTO " . DB_CITY . " 
		SET 
    country_id='" . ConvertRealString($_REQUEST['country_id']) . "',
  ...
  if($qry_inset_post){
    ...
    $_SESSION['MSG_ALERT'] = "Information inserted failed.";
    $_SESSION['IMG_PATH'] = "fa-check";
...
function delete_about()
{
	...
	global $link;
	$sql_delete_about = "UPDATE " . DB_CITY . " 
                    SET 
					status= 'D'
                    where id='" . $_REQUEST['id'] . "'";
	$qry_delete_about = mysqli_query($link, $sql_delete_about) or die(mysqli_error($link));
...
function delete_chk_about()
{
	...
	foreach ($_REQUEST['public_chkbox'] as $val) {
		if ($val != 'on') {
			...
			$sql_deletepublication = "UPDATE " . DB_CITY . " 
											SET 
											status= 'D'
											where id='" . $val . "'";
...
function edit()
{
	...
	global $link;
	$sql_edit_about = "SELECT * FROM " . DB_CITY . "  where id ='" . $_REQUEST['id'] . "'";
...
?>
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 breadcrumb-header">
					<div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?= $_SERVER['PHP_SELF'] ?>">City</a><a href="#" class="current">Edit</a></div>
				</div>
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel tabbed-panel panel-success">
						<div class="panel-heading clearfix">
							<div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit City</strong></a></div>
						</div>
										...
										<table width="100%">
											<tbody>
												...
												<tr>
													...
													<td width="87%">
														<div class="col-lg-6">
															<div class="form-group"><img src="../../uploads/city/<?php echo $row_edit_about['image_name']; ?>" width="60px" /></div>
															<!-- /input-group -->
														</div>
													</td>
												</tr>
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    <select class="form-control" name="country_id" id="country_id">
                                      ...
                                      $sql_query = mysqli_query($link, $sql_select);
                                      while ($row = mysqli_fetch_array($sql_query)) {
                                        if($row_edit_about['country_id']==$row["id"]){
                                          ?>
                                  ...
                                  <!-- /input-group -->
												...
												<tr>
													<td width="15%">City Name. <font color="#ff0000">*</font>
													</td>
													<td width="3%">&nbsp;</td>
													<td width="87%">
														<div class="col-lg-6">
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        country_id: 'required'
			...
			messages: {
				main_title: "Please enter country name...!",
        ...
        country_id: 'required'
			...
			messages: {
				main_title: "Please enter city name...!",
        country_id: 'Please select country name...!'
			},
			errorElement: 'label',
			errorPlacement: function(error, element) {
