...
$sql_list_about = "SELECT * FROM ".DB_BANNER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_BANNER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
                    ...
                    <div class="table-responsive">
                      <table width="100%">
                        <tbody>
                          ...
                          <tr>
                            <td width="14%">Description <font color="#ff0000">*</font></td>
                            <td width="2%">&nbsp;</td>
                            <td width="84%"><div class="col-lg-6">
                                <div class="form-group">
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_banner.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function delete_about()
{
		...
		$_SESSION['MSG_ALERT'] = "Latest banner has been successfully deleted.";
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            ...
                            <p id="image_name_alert" style="color:#F00;"></p>
                            <div class="form-group"><img src="../../uploads/banner/<?php echo $row_edit_about['image_name']?>" width="100px" /></div>
                          </div></td>
                      </tr>                     
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            <div class="form-group"> <span class="input">
                              <textarea id="myTextarea" name="main_title" class="form-control">
                                  <?php echo stripslashes(($row_edit_about['main_title']));?>
                                  </textarea>
                              </span></div>
                            <!-- /input-group --> 
                          </div></td>
...
//------------------------------ Image validation ---------------------------------------
	  function validateimg_s(file) {
		...
		v666ar arrayExtensions = ["jpg" , "jpeg", "png"];
