...
$sql_list_about = "SELECT * FROM ".DB_NEWSLETTER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_NEWSLETTER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Subscriber</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Subscriber Details</strong></a></div>
...
{
	var UserResp = window.confirm("Are you sure to delete this Subscriber?");
	if( UserResp == true )
	{
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_subscriber.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	global $link;	
	 ...
	 $sql_inset_post="INSERT INTO ".DB_NEWSLETTER." 
...
global $link;
		$sql_delete_about= "UPDATE ".DB_NEWSLETTER." 
                    SET 
					status= 'D'
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_NEWSLETTER." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_NEWSLETTER."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">Subscriber</a><a href="#" class="current">View</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-eye fa-fw"></i> View Subscriber</strong></a></div>
          </div>
                  ...
                  <table width="100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="82%"><div class="col-lg-6">
                            <div class="form-group">
                              <?php echo $row_edit_about['main_title'];?>
                              </div>
                            <!-- /input-group --> 
                          </div></td>
                      </tr>
...
function edit_about()
	...
	global $link;
		 ...
		 $sql_inset_post="UPDATE ".DB_NEWSLETTER." 
                    SET 
					main_title = '".ConvertRealString($_REQUEST['main_title'])."'
