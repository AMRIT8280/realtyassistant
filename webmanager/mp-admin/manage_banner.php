...
function main()
{
  ...
  $sql_list_about = "SELECT * FROM " . DB_BANNER . "  WHERE 1 " . $con . " AND status!='D'";
  $qry_list_about = mysqli_query($link, $sql_list_about);
  $num_list_about = mysqli_num_rows($qry_list_about);


  $countShow = "SELECT count(*) FROM " . DB_BANNER . "  WHERE 1 " . $con . " AND status!='D'";
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 breadcrumb-header">
          <div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Banner</a></div>
        </div>
      </div>
      <!-- /.row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="panel tabbed-panel panel-success">
            <div class="panel-heading clearfix">
              <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Banner Details</strong></a></div>
                            ...
                            <?php if ($num_list_about > 0) { ?>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <?php
                                      if(pathinfo($row_list_about['image_name'], PATHINFO_EXTENSION)=="mp4"){
                                      ?>
                                        <video autoplay muted loop id="myVideo" width="70px">
                                            <source src="../../uploads/banner/<?php echo $row_list_about['image_name'];?>" type="video/mp4">
                                            Your browser does not support HTML5 video.
                                        </video> 
                                      <?php
                                      }else{
                                      ?>
                                        <img src="../../uploads/banner/<?php echo $row_list_about['image_name'] ?>" width="70px" />
                                      <?php
                                      }
                                    ?>
                                  </td>
                                  <td><?php echo stripslashes(br2nl($row_list_about['main_title'])); ?></td>
                                  <td><?php echo stripslashes(br2nl($row_list_about['sub_title'])); ?></td>
                                  <td><?php echo stripslashes(br2nl($row_list_about['description'])); ?></td>
                      ...
                      <div class="table-responsive">
                        <table width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td width="14%">Title <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    <textarea id="myTextarea" name="main_title" class="form-control"></textarea>
                                  </div>
                                  <!-- /input-group -->
                                </div>
                              </td>
                            ...
                            <tr>
                              <td width="14%">Sub-Title <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    <textarea id="myTextarea" name="sub_title" class="form-control"></textarea>
                                  </div>
                                  <!-- /input-group -->
                                </div>
                              </td>
                            ...
                            <tr>
                              <td width="14%">Description <font color="#ff0000">*</font>
                              </td>
                              <td width="2%">&nbsp;</td>
                              <td width="84%">
                                <div class="col-lg-6">
                            ...
                            <!--<tr>
                            <td width="14%">Sub Title <font color="#ff0000">*</font></td>
                            <td width="2%">&nbsp;</td>
                            <td width="84%"><div class="col-lg-6">
                                <div class="form-group">
                                  <input type="text" class="form-control" id="sub_title" name="sub_title" placeholder="Enter sub title" autocomplete="off">
                                </div>
                              </div></td>
                          </tr>-->
                            <tr>
                            ...
                            <tr>
                              <td colspan="3"><input type="hidden" name="id" value="">
                                ...
                                <a href="manage_banner.php" class="btn btn-default">Cancel</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
function insert_about()
{
  ...
  $sql_inset_post = "INSERT INTO " . DB_BANNER . " 

		SET 
		image_name='" . $file_name_image . "',
		main_title = '" . addslashes(nl2br($_REQUEST['main_title'])) . "'";
  ...
  redirect_mp('manage_banner');
  exit();
}

function delete_about()
{
  $result = deleteRecord(DB_BANNER, 'id=' . $_REQUEST['id']);
...
function delete_chk_about()
{
  ...
  foreach ($_REQUEST['public_chkbox'] as $val) {
    if ($val != 'on') {
      ...
      $sql_deletepublication = "UPDATE " . DB_BANNER . " 
											SET 
											status= 'D'
											where id='" . $val . "'";
...
function edit()
{
  ...
  global $link;
  $sql_edit_about = "SELECT * FROM " . DB_BANNER . "  where id ='" . $_REQUEST['id'] . "'";
  $qry_edit_about = mysqli_query($link, $sql_edit_about);
...
?>
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 breadcrumb-header">
          <div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?= $_SERVER['PHP_SELF'] ?>">Banner</a><a href="#" class="current">Edit</a></div>
        </div>
      </div>
      <!-- /.row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="panel tabbed-panel panel-success">
            <div class="panel-heading clearfix">
              <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Banner</strong></a></div>
            </div>
                  ...
                  <div class="table-responsive">
                    <table width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td width="15%">Upload Image/Video</td>
                          <td width="3%">&nbsp;</td>
                          <td width="87%">
                            <div class="col-lg-6">
                              <div class="form-group">
                                <input type="file" class="form-control" accept=".png, .jpg, .jpeg, .mp4" id="image_name" name="image_name" onchange="validateimg_s(this.value)">
                              </div>
                              <p id="image_name_alert" style="color:#F00;"></p>
                              <div class="form-group">
                              <?php
                                      if(pathinfo($row_edit_about['image_name'], PATHINFO_EXTENSION)=="mp4"){
                                      ?>
                                        <video autoplay muted loop id="myVideo" width="100px">
                                            <source src="../../uploads/banner/<?php echo $row_edit_about['image_name'];?>" type="video/mp4">
                                            Your browser does not support HTML5 video.
                                        </video> 
                                      <?php
                                      }else{
                                      ?>
                                        <img src="../../uploads/banner/<?php echo $row_edit_about['image_name'] ?>" width="100px" />
                                      <?php
                                      }
                              ?>
                              </div>
                        ...
                        <tr>
                          <td width="15%">Sub Title <font color="#ff0000">*</font></td>
                          <td width="3%">&nbsp;</td>
                          <td width="87%">
                            <div class="col-lg-6">
                              <div class="form-group">
                                <span class="input">
                                  <input type="text" class="form-control" id="sub_title" name="sub_title" value="<?php echo $row_edit_about['sub_title']; ?>" autocomplete="off">
                                </span>
                              </div> 
                            </div>
                          </td>
                        ...
                        <tr>
                          <td width="15%">Description<font color="#ff0000">*</font></td>
                          <td width="3%">&nbsp;</td>
                          <td width="87%">
                            <div class="col-lg-6">
                              <div class="form-group">
...
function edit_about()
{
  ...
  if ($_FILES['image_name']['name'] != "") {
    ...
    $tmp_name = $_FILES['image_name']['tmp_name'];
    move_uploaded_file($tmp_name, $upload_dir . $file_name_image);
    $sql_inset_post = "UPDATE " . DB_BANNER . " 
                    SET 
					image_name='" . $file_name_image . "'
  ...
  $sql_inset_post = "UPDATE " . DB_BANNER . " 
                    SET
					main_title = '" . addslashes(nl2br($_REQUEST['main_title'])) . "',
          sub_title = '" . addslashes(nl2br($_REQUEST['sub_title'])) . "',
...
<script type="text/javascript">
  ...
  function validateimg_s(file) {
    ...
    var arrayExtensions = ["jpg", "jpeg", "png", "mp4"];
