...
$sql_list_about = "SELECT * FROM ".DB_ABOUTUS."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_ABOUTUS."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">About</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>About Details</strong></a></div>
                      ...
                      <table id="dataTables-example" class="table table-striped table-bordered">
						...
						?>
                          <tr>
                            ...
                            <td><?php echo WordLimiter(stripslashes(($row_list_about['descript'])),10)?></td>
...
{
	var UserResp = window.confirm("Are you sure to delete this About?");
	if( UserResp == true )
	{
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_about.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	global $link;	
	 ...
	 $sql_inset_post="INSERT INTO ".DB_ABOUTUS." 
...
global $link;
		$sql_delete_about= "UPDATE ".DB_ABOUTUS." 
                    SET 
					status= 'D'
                    where id='".$_REQUEST['id']."'";   
		$qry_delete_about=mysqli_query($link,$sql_delete_about) or die(mysqli_error());
		
		$_SESSION['MSG_ALERT'] = "Latest About has been successfully deleted.";
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_ABOUTUS." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_ABOUTUS."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">About</a><a href="#" class="current">Edit</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit About</strong></a></div>
          </div>
                ...
                <div class="table-responsive">
                  <table width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td width="15%">About Name <font color="#ff0000">*</font></td>
                        <td width="3%">&nbsp;</td>
                        <td width="82%"><div class="col-lg-6">
                            <div class="form-group">
...
function edit_about()
	...
	global $link;
		 ...
		 $sql_inset_post="UPDATE ".DB_ABOUTUS." 
                    SET 
					main_title = '".ConvertRealString($_REQUEST['main_title'])."', 
