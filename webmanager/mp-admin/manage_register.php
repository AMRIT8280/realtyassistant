...
$sql_list_about = "SELECT * FROM ".DB_REGISTER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_REGISTER."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Register</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Register user Details</strong></a></div>
                      ...
                      <table id="export_table" class="table table-striped table-bordered">
						...
						?>
                          <tr>
                            ...
                            <td><?php  echo $row_list_about['contact_mail']; ?></td>
                            <td><?php  echo $row_list_about['mobile_no']; ?></td>
                    ...
                    <div class="table-responsive">
                      <table width="100%">
                        <tbody>
                          ...
                          <tr>
                            <td width="15%">Mobile No <font color="#ff0000">*</font></td>
                            <td width="3%">&nbsp;</td>
                            <td width="87%"><div class="col-lg-6">
                                <div class="form-group">
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_register.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
global $link;
		$sql_delete_about= "UPDATE ".DB_REGISTER." 
                    SET 
					status= 'D'
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_REGISTER." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_REGISTER."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">Register user</a><a href="#" class="current">Edit</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Register user</strong></a></div>
          </div>
                  ...
                  <table width="100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            <div class="form-group">
                              <input type="email" class="form-control" id="contact_mail" name="contact_mail" placeholder="Enter Email" value="<?php echo $row_edit_about['contact_mail'];?>" autocomplete="off">
                            </div>
                            <!-- /input-group --> 
                          </div></td>
                      </tr>
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            <div class="form-group">
                              <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Enter Phone" value="<?php echo $row_edit_about['mobile_no'];?>" autocomplete="off">
                            </div>
                            <!-- /input-group --> 
                          </div></td>
                      </tr>                    
