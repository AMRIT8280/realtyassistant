...
$sql_list_about = "SELECT * FROM ".DB_COLLABORATION."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_COLLABORATION."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Collaboration people</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Collaboration people Details</strong></a></div>
...
{
	var UserResp = window.confirm("Are you sure to delete this Collaboration people?");
	if( UserResp == true )
	{
...
function insert_about(){
	global $link;	
	 ...
	 $sql_inset_post="INSERT INTO ".DB_COLLABORATION." 
...
global $link;
		$sql_delete_about= "UPDATE ".DB_COLLABORATION." 
                    SET 
					status= 'D'
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_COLLABORATION." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_COLLABORATION."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">Collaboration people</a><a href="#" class="current">View</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-eye fa-fw"></i> View Collaboration people</strong></a></div>
          </div>
...
function edit_about()
	...
	global $link;
			 ...
			 $sql_inset_post="UPDATE ".DB_COLLABORATION." 
                    SET
					company_name	= '".ConvertRealString(ucwords($_REQUEST['company_name']))."',
					contact_no		= '".ConvertRealString($_REQUEST['contact_no'])."',
					email 			= '".ConvertRealString($_REQUEST['email'])."',
