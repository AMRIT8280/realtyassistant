...
$sql_list_about = "SELECT * FROM ".DB_DIRECTORIES."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_DIRECTORIES."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Directories</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Directories 
</strong></a></div>
                      ...
                      <table id="dataTables-example" class="table table-striped table-bordered">
						...
						?>
                          <tr>
                            ...
                            <td><?php  echo get_directories_cat_name($row_list_about['type']); ?></td>   
                        ...
                        <tbody>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                  <select class="form-control" name="type" id="type">
                                      ...
                                      <?php
                                      	$sql_categ = "SELECT id,main_title FROM ".DB_DIRECTORIES_CATEGORY."  WHERE status ='A' ORDER BY main_title ASC";	
										$qry_categ = mysqli_query($link,$sql_categ);
										$num_categ = mysqli_num_rows($qry_categ);
										if($num_categ>0){
										while($row_categ=mysqli_fetch_array($qry_categ)){
									  ?>
                                      <option value="<?php echo $row_categ['id'];?>"><?php echo $row_categ['main_title'];?></option>
                                      <?php }}?>
                                  </select>
                                  </div>
                                <!-- /input-group --> 
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_directories.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	...
	if($_FILES['image_name']['name']!="")
	 ...
	 $sql_inset_post="INSERT INTO ".DB_DIRECTORIES." 
	...
	$qry_inset_post	=mysqli_query($link,$sql_inset_post);	
		...
		$_SESSION['DIV_CLASS'] ="alert-success"; 
		 ...
		 redirect_mp('manage_directories');
	exit();
...
{
		$result = deleteRecord(DB_DIRECTORIES,'id='.$_REQUEST['id']);
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_DIRECTORIES." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_DIRECTORIES."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">Directories</a><a href="#" class="current">Edit</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Directories</strong></a></div>
          </div>
                            ...
                            <div class="form-group">
                              <select class="form-control" name="type" id="type">
                                  ...
                                  <?php
                                    ...
                                    while($row_categ=mysqli_fetch_array($qry_categ)){
                                  ?>
                                  <option value="<?php echo $row_categ['id'];?>" <?php if($row_edit_about['type']==$row_categ['id']) echo 'selected';?>><?php echo $row_categ['main_title'];?></option>
                                  <?php }}?>
                              </select>
                              </div>
                            <!-- /input-group --> 
	...
	if($_FILES['image_name']['name']!="")

			{
				$file_explode = explode(".",$_FILES['image_name']['name']);
					...
					$tmp_name=$_FILES['image_name']['tmp_name'];
					move_uploaded_file($tmp_name,$upload_dir.$file_name_image);
					$sql_inset_post="UPDATE ".DB_DIRECTORIES." 
                    SET 
					image_name='".$file_name_image."'
