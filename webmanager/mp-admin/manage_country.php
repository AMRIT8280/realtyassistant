...
function main()
{
	...
	$sql_list_about = "SELECT * FROM " . DB_COUNTRY . "  WHERE 1 " . $con . " AND status!='D' ORDER BY id DESC";
	$qry_list_about = mysqli_query($link, $sql_list_about);
	$num_list_about = mysqli_num_rows($qry_list_about);


	$countShow = "SELECT count(*) FROM " . DB_COUNTRY . "  WHERE 1 " . $con . " AND status!='D' ORDER BY id DESC";
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 breadcrumb-header">
					<div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Country</a></div>
				</div>
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel tabbed-panel panel-success">
						<div class="panel-heading clearfix">
							<div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Country Details</strong></a></div>
														...
														<?php if ($num_list_about > 0) { ?>
															...
															?>
																<tr>
																	...
																	<td><?php echo $cnt++ ?></td>
																	<td>
																		<img src="../../uploads/country/<?php echo $row_list_about['image_name'] ?>" width="60px" />
																	</td>
											...
											<div class="table-responsive">
												<table width="100%">
													<tbody>
														...
														<tr>
															<td width="14%">Country Name<font color="#ff0000">*</font>
															</td>
															<td width="2%">&nbsp;</td>
															<td width="84%">
																<div class="col-lg-6">
														...
														<tr>
															<td colspan="3"><input type="hidden" name="id" value="">
																...
																<a href="manage_country.php" class="btn btn-default">Cancel</a>
															</td>
														</tr>
													</tbody>
												</table>
...
function insert_about()
{
	...
	$sql_inset_post = "INSERT INTO " . DB_COUNTRY . " 
...
function delete_about()
{
	...
	global $link;
	$sql_delete_about = "UPDATE " . DB_COUNTRY . " 
                    SET 
					status= 'D'
...
function delete_chk_about()
{
	...
	foreach ($_REQUEST['public_chkbox'] as $val) {
		if ($val != 'on') {
			...
			$sql_deletepublication = "UPDATE " . DB_COUNTRY . " 
											SET 
											status= 'D'
											where id='" . $val . "'";
...
function edit()
{
	...
	global $link;
	$sql_edit_about = "SELECT * FROM " . DB_COUNTRY . "  where id ='" . $_REQUEST['id'] . "'";
...
?>
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 breadcrumb-header">
					<div id="breadcrumb" class="tooltip-demo"> <a href="<?= URL ?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?= $_SERVER['PHP_SELF'] ?>">Country</a><a href="#" class="current">Edit</a></div>
				</div>
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel tabbed-panel panel-success">
						<div class="panel-heading clearfix">
							<div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Country</strong></a></div>
						</div>
										...
										<table width="100%">
											<tbody>
												...
												<tr>
													...
													<td width="87%">
														<div class="col-lg-6">
															<div class="form-group"><img src="../../uploads/country/<?php echo $row_edit_about['image_name'] ?>" width="60px" /></div>
															<!-- /input-group -->
														</div>
													</td>
												</tr>
...
function edit_about()
{
	...
	if ($_FILES['image_name']['name'] != "") {
		...
		$tmp_name = $_FILES['image_name']['tmp_name'];
		move_uploaded_file($tmp_name, $upload_dir . $file_name_image);
		$sql_inset_post = "UPDATE " . DB_COUNTRY . " 
                    SET 
					image_name='" . $file_name_image . "'
                    where id='" . $_REQUEST['id'] . "'";
		$qry_inset_post	= mysqli_query($link, $sql_inset_post);
