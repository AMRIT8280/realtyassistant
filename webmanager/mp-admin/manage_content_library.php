...
$sql_list_about = "SELECT * FROM ".DB_CONTENT_LIBRARY."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_CONTENT_LIBRARY."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">Content Library</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>Content Library
</strong></a></div>
                      ...
                      <table id="dataTables-example" class="table table-striped table-bordered">
						...
						?>
                          <tr>
                            ...
                            <td><?php  echo $cnt++?></td>
                            <td>
								<img src="../../uploads/content_library/<?php echo $row_list_about['image_name']?>" width="70px" />
                            </td>                             
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manage_content_library.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	global $link;	
	$upload_dir='../../uploads/content_library/';
	...
	if($_FILES['image_name']['name']!="")
	 ...
	 $sql_inset_post="INSERT INTO ".DB_CONTENT_LIBRARY." 
	...
	$qry_inset_post	=mysqli_query($link,$sql_inset_post);	
		...
		$_SESSION['DIV_CLASS'] ="alert-success"; 
		 ...
		 redirect_mp('manage_content_library');
	exit();
...
{
		$result = deleteRecord(DB_CONTENT_LIBRARY,'id='.$_REQUEST['id']);
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_CONTENT_LIBRARY." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_CONTENT_LIBRARY."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">Content Library</a><a href="#" class="current">Edit</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-edit fa-fw"></i> Edit Content Library</strong></a></div>
          </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            ...
                            <p id="image_name_alert" style="color:#F00;"></p>
                            <div class="form-group"><img src="../../uploads/content_library/<?php echo $row_edit_about['image_name']?>" width="100px" /></div>
                          </div></td>
                      </tr>                     
                      <tr>
	...
	if($_FILES['image_name']['name']!="")

			{
				$file_explode = explode(".",$_FILES['image_name']['name']);
					...
					$tmp_name=$_FILES['image_name']['tmp_name'];
					move_uploaded_file($tmp_name,$upload_dir.$file_name_image);
					$sql_inset_post="UPDATE ".DB_CONTENT_LIBRARY." 
                    SET 
					image_name='".$file_name_image."'
