...
$sql_list_about = "SELECT * FROM ".DB_TOUR."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";	
$qry_list_about = mysqli_query($link,$sql_list_about);
$num_list_about = mysqli_num_rows($qry_list_about);


$countShow="SELECT count(*) FROM ".DB_TOUR."  WHERE 1 ".$con." AND status!='D' ORDER BY id DESC";
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="#" class="current">People</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong>People Details</strong></a></div>
...
{
	var UserResp = window.confirm("Are you sure to delete this People?");
	if( UserResp == true )
	{
                    ...
                    <div class="table-responsive">
                      <table width="100%">
                        <tbody>
                          ...
                          <tr>
                            <td width="15%"> Frist Name <font color="#ff0000">*</font></td>
                            <td width="3%">&nbsp;</td>
                          ...
                          <tr>
                            <td colspan="3"><input type="hidden" name="id" value="">
                              ...
                              <a href="manamge_tour_people.php" class="btn btn-default">Cancel</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
function insert_about(){
	global $link;	
	 ...
	 $sql_inset_post="INSERT INTO ".DB_TOUR." 

		SET 
		fname			= '".ConvertRealString(ucwords($_REQUEST['fname']))."',
		lname			= '".ConvertRealString(ucwords($_REQUEST['lname']))."',
	...
	$qry_inset_post	=mysqli_query($link,$sql_inset_post);	
		...
		$_SESSION['DIV_CLASS'] ="alert-success"; 
		 ...
		 redirect_mp('manamge_tour_people');
	exit();
...
global $link;
		$sql_delete_about= "UPDATE ".DB_TOUR." 
                    SET 
					status= 'D'
				...
				if($val!='on')
					{
							...
							$sql_deletepublication = "UPDATE ".DB_TOUR." 
											SET 
											status= 'D'
											where id='".$val."'";
...
function edit(){
	...
	global $link;
$sql_edit_about = "SELECT * FROM ".DB_TOUR."  where id ='".$_REQUEST['id']."'";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 breadcrumb-header">
        <div id="breadcrumb" class="tooltip-demo"> <a href="<?=URL?>" title="Go to Home" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home fa-fw"></i> Home</a><a href="<?=$_SERVER['PHP_SELF']?>">People</a><a href="#" class="current">View</a></div>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel tabbed-panel panel-success">
          <div class="panel-heading clearfix">
            <div class="panel-title pull-left"><a data-toggle="collapse" href="#collapseOne" aria-expanded="false"><strong><i class="fa fa-eye fa-fw"></i> View People</strong></a></div>
          </div>
                ...
                <div class="table-responsive">
                  <table width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td width="15%"> People Name</td>
                        <td width="3%">&nbsp;</td>
                        <td width="87%"><div class="col-lg-6">
                            <div class="form-group"> <span class="input">
                             : <?php echo $row_edit_about['fname'];?> <?php echo $row_edit_about['lname'];?>
                              </span></div>
                            <!-- /input-group --> 
                          </div></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td width="87%"><div class="col-lg-6">
                            <div class="form-group">
                              : <?php echo stripslashes(($row_edit_about['message']));?>
                            </div>
                            <!-- /input-group --> 
                          </div></td>
                      </tr>               
